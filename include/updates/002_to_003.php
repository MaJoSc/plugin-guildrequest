<?PHP
  ...
  $updateDESC = array('',	
                      ...
                      'Insert default values \'Spec\' for the new application form',
  ...
  $updateSQL =  array("CREATE TABLE IF NOT EXISTS __guildrequest_appvalues(
                      ...
                      "INSERT INTO __guildrequest_appvalues(value, type, required) 
                        VALUES ('Name', 'single_text', 'Y');",
                      "INSERT INTO __guildrequest_appvalues(value, type, required) 
                        VALUES ('Class', 'single_text', 'Y');",
                      "INSERT INTO __guildrequest_appvalues(value, type, required) 
                        VALUES ('Level', 'single_text', 'N');",
                      "INSERT INTO __guildrequest_appvalues(value, type, required) 
                        VALUES ('Spec', 'single_text', 'N');",
