...
$lang['gr_mail_topic']                    = 'Bestätigung deiner Bewerbung bei '.preg_replace("'", "\'", $eqdkp->config['guildtag']);
...
$lang['gr_welcome_text']                  = 'Vielen Dank für dein Interesse an '.preg_replace("'", "\'", $eqdkp->config['guildtag']).'. Bitte schreibe deine Bewerbung hier:';
